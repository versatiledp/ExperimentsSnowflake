CREATE OR REPLACE PROCEDURE pr_AcademicInstitution_Load(YEAR FLOAT)
  RETURNS STRING
  LANGUAGE javascript
  EXECUTE AS OWNER
  AS
...
AND (
  ...
  OR IFNULL(T.StatusOfInstitution, '') <> IFNULL(S.StatusOfInstitution, '')
  OR IFNULL(T.UnitidForMergedSchools, 0) <> IFNULL(S.UnitidForMergedSchools, 0)
  OR IFNULL(T.YearInstitutionWasDeletedFromIPEDS, 0) <> IFNULL(S.YearInstitutionWasDeletedFromIPEDS, 0)
  OR IFNULL(T.DateInstitutionClosed, '') <> IFNULL(S.DateInstitutionClosed, '')
  OR IFNULL(T.InstitutionIsActive, 0) <> IFNULL(S.InstitutionIsActive, 0)
  OR IFNULL(T.PrimarilyPostsecondaryIndicator, 0) <> IFNULL(S.PrimarilyPostsecondaryIndicator, 0)
  OR IFNULL(T.PostsecondaryInstitutionIndicator, 0) <> IFNULL(S.PostsecondaryInstitutionIndicator, 0)
  OR IFNULL(T.PostsecondaryAndTitleIvInstitutionIndicator, 0) <> IFNULL(S.PostsecondaryAndTitleIvInstitutionIndicator, 0)
  OR IFNULL(T.ReportingMethodForStudentCharges, 0) <> IFNULL(S.ReportingMethodForStudentCharges, 0)
  OR IFNULL(T.InstitutionalCategory, 0) <> IFNULL(S.InstitutionalCategory, 0)
  OR IFNULL(T.LandGrantInstitution, 0) <> IFNULL(S.LandGrantInstitution, 0)
  ...
  OR IFNULL(T.NewEnglandCityAndTownArea, 0) <> IFNULL(S.NewEnglandCityAndTownArea, 0)
  OR IFNULL(T.FIPSCountyCode, 0) <> IFNULL(S.FIPSCountyCode, 0)
  OR IFNULL(T.CountyName, '') <> IFNULL(S.CountyName, '')
  OR IFNULL(T.StateAnd114thCongressionalDistrictID, 0) <> IFNULL(S.StateAnd114thCongressionalDistrictID, 0)
...
SET
  ...
  HistoricallyBlackCollegeOrUniversity = S.HistoricallyBlackCollegeOrUniversity,
  ...
  InstitutionOpenToGeneralPublic = S.InstitutionOpenToGeneralPublic,
  StatusOfInstitution = S.StatusOfInstitution,
  UnitidForMergedSchools = S.UnitidForMergedSchools,
  YearInstitutionWasDeletedFromIPEDS = S.YearInstitutionWasDeletedFromIPEDS,
  ...
  PostsecondaryAndTitleIvInstitutionIndicator = S.PostsecondaryAndTitleIvInstitutionIndicator,
  ...
  IdentificationNumberOfMultiCampusOrganization = S.IdentificationNumberOfMultiCampusOrganization,
  CoreBasedStatisticalArea = S.CoreBasedStatisticalArea,
  CBSATypeMetropolitanMicropolitan = S.CBSATypeMetropolitanMicropolitan,
  ...
  StateAnd114thCongressionalDistrictID = S.StateAnd114thCongressionalDistrictID,
