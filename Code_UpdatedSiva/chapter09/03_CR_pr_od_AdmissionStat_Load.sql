...
var sql_command = `
  ...
  RowNumber
	...
	SELECT 
		...
		$1:SATNUM::INTEGER AS FirstTimeDegreeOrCertificateSeekingStudentsSubmittingSATScores, 
		$1:SATPCT::INTEGER AS PercentFirstTimeDegreeOrCertificateSeekingStudentsSubmittingSATScores, 
		$1:ACTNUM::INTEGER AS FirstTimeDegreeOrCertificateSeekingStudentsSubmittingACTScores, 
		$1:ACTPCT::INTEGER AS PercentOfFirstTimeDegreeOrCertificateSeekingStudentsSubmittingACTScores, 
		$1:SATVR25::INTEGER AS SATEvidenceBasedReadingWriting25thPercentileScore, 
