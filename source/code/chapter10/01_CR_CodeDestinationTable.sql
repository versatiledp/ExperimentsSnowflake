...
SELECT 'carnegie','CarnegieClassification2000'  UNION ALL
...
SELECT 'f1syscod','IdentificationNumberMultiCampusOrganization'
						UNION ALL
...
SELECT 'pset4flg','PostsecondaryTitleIVInstitutionIndicator'
					UNION ALL
