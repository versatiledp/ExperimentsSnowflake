CREATE OR REPLACE PROCEDURE pr_AdmissionStat_Load (YEAR FLOAT)
RETURNS string
LANGUAGE javascript
EXECUTE AS OWNER
AS
$$
var sql_DelCommand = `DELETE FROM AdmissionStat WHERE AcademicYear = `+ YEAR.toString()
var sql_Command =

INSERT INTO
   AdmissionStat ( AcademicInstitutionUniqueDWSID, 
